<?php
namespace TorinoMotors\ModuleAjax\Model\Product\Attribute\Backend;

use Magento\Framework\App\Filesystem\DirectoryList;

class Archivo extends \Magento\Eav\Model\Entity\Attribute\Backend\AbstractBackend
{
    const MEDIA_SUBFOLDER = 'productos/torino';
